...
const COMMANDS = [
  ...
  { label: 'فاتورة مبيع جديدة', to: '/invoices/new?type=STOCK_OUT', icon: Plus, keywords: 'بيع sale اخراج out جديدة' },
  { label: 'فاتورة شراء جديدة', to: '/invoices/new?type=STOCK_IN', icon: Plus, keywords: 'شراء purchase ادخال in جديدة' },
